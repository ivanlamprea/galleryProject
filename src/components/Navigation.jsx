...
const Navigation = () => {
  ...
  return (
    <div className='absolute left-0 right-0 w-5/6 mx-auto flex justify-center bottom-0 bg-black/80 pt-2'>
      ...
      <NavLink to="/galeria/2" className={ ({isActive}) => isActive ? "group active" : ""}>
      ...
      <NavLink to="/galeria/3" className={ ({isActive}) => isActive ? "group active" : ""}>
      ...
      <NavLink to="/galeria/4" className={ ({isActive}) => isActive ? "group active" : ""}>
      ...
      <NavLink to="/galeria/5" className={ ({isActive}) => isActive ? "group active" : ""}>
      ...
      <NavLink to="/galeria/6" className={ ({isActive}) => isActive ? "group active" : ""}>
      ...
      <NavLink to="/galeria/7" className={ ({isActive}) => isActive ? "group active" : ""}>
      ...
      <NavLink to="/galeria/8" className={ ({isActive}) => isActive ? "group active" : ""}>
      ...
      <NavLink to="/galeria/9" className={ ({isActive}) => isActive ? "group active" : ""}>
      ...
      <NavLink to="/galeria/10" className={ ({isActive}) => isActive ? "group active" : ""}>
